...
agent |>
  interrogate() |>
  get_agent_report() |>
  export_report("results/reports/validation_report.html")
}

cat ("Check results/reports/validation_report.html, to see if all tests passed \n")
main(opt$input_file)